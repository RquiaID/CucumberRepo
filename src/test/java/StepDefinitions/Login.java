...
public class Login extends CommonMethods {
    ...
    public void user_enters_valid_email_and_valid_password() {
        ...
        // I have to create object of login page

        //LoginPage login=new LoginPage();

        // driver.findElement(By.id("txtUsername")).sendKeys(ConfigReader.getPropertyValue(""));
       // WebElement usernameTextBox = driver.findElement(By.id("txtUsername"));
        ...
        //WebElement passwordTextBox = driver.findElement(By.id("txtPassword")); I comment it because i have made a seperate class for it which keeps the webelements
